...
<head>
  ...
  <title>MejaBaca| Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Meja</b>Baca</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('assets/admin/dist/img/user4-128x128.png')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('assets/admin/dist/img/user3-128x128.png')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Sales Department
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <b> {{ Auth::user()->name }}</b>
                  <small>{{ Auth::user()->name }} since Oct. 2019</small>
                </p>
              </li>
              <!-- Menu Body -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('admin/penerbit')}}"><i class="fa fa-circle-o"></i> Penerbit</a></li>
